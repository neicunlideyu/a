...
@Service("reopenPullRequestNotificationRuleBean")
public class ReopenPullRequestNotificationRule implements NotificationRule {
    ...
    public boolean ifNotify(Activity activity, Subscribable original, Subscribable updated) {
        return PullRequestHelper.isReopenOperation((PullRequest) original, (PullRequest) updated);
    }
