...
public class ReviewExample implements BaseExample {
    /**
     ...
     * @mbggenerated Sun Dec 01 20:38:08 CST 2013
     */
    public ReviewExample(ReviewObject sample) {
        oredCriteria = new ArrayList<Criteria>();
        ...
        if (sample.getFile() != null) {
            criteria.andFileEqualTo(sample.getFile());
        }
        if (sample.getLine() != null) {
            criteria.andLineEqualTo(sample.getLine());
        }
        ...
        if (sample.getLine_type() != null) {
            criteria.andLine_typeEqualTo(sample.getLine_type());
        }
